...
import top.walterke.annotation.OperationLogger;
...
import top.walterke.service.CommentService;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.walterke.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.walterke.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.walterke.model.dto.Blog blog, String type) {
		//验证普通字段
