package top.walterke.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.walterke.config.properties.BlogProperties;
import top.walterke.constant.PageConstants;
import top.walterke.constant.RedisKeyConstants;
import top.walterke.entity.User;
import top.walterke.model.dto.Comment;
...
import top.walterke.util.MailUtils;
import top.walterke.util.QQInfoUtils;
import top.walterke.util.StringUtils;
import top.walterke.util.comment.channel.ChannelFactory;
import top.walterke.util.comment.channel.CommentNotifyChannel;
import top.walterke.enums.CommentOpenStateEnum;
import top.walterke.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.walterke.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.walterke.entity.Comment parentComment, Comment comment) {
