package top.walterke.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.walterke.entity.ScheduleJobLog;
import top.walterke.service.ScheduleJobService;
import top.walterke.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.walterke.entity.ScheduleJob scheduleJob = (top.walterke.entity.ScheduleJob) context.getMergedJobDataMap().get(top.walterke.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
